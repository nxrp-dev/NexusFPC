...
create sequence seqCheckAll;

create table CHECKALLRTL (
  CA_ID BIGINT NOT NULL default nextval('seqCheckAll'),
  CA_PLATFORM_FK INT NOT NULL,
  CA_DATE DATE NOT NULL DEFAULT CURRENT_DATE,
  CA_STEP1 BOOLEAN NOT NULL DEFAULT 't',
  CA_STEP2 BOOLEAN NOT NULL DEFAULT 't',
  CA_STEP3 BOOLEAN NOT NULL DEFAULT 't',
  CA_STEP4 BOOLEAN NOT NULL DEFAULT 't',
  CA_STEP5 BOOLEAN NOT NULL DEFAULT 't',
  CA_STEP6 BOOLEAN NOT NULL DEFAULT 't',
  CONSTRAINT PK_CHECKALLRTL PRIMARY KEY (CA_ID)
);


create sequence seqCheckAllLog;

create table CHECKALLRTLLOG (
  CAL_ID BIGINT NOT NULL default nextval('seqCheckAllLog'),
  CAL_CHECKALLRTL_FK BIGINT NOT NULL,
  CAL_STEP SMALLINT NOT NULL,
  CAL_LOG text,
  CONSTRAINT PK_PK_CHECKALLRTLLOG PRIMARY KEY (CAL_ID)
);


CREATE UNIQUE INDEX UDX_CHECKALLRTLLOG ON CHECKALLRTLLOG(CAL_CHECKALLRTL_FK,CAL_STEP);
...
ALTER TABLE CHECKALLRTL ADD CONSTRAINT CHECKALLRTL_PLATFORM_FK FOREIGN KEY (CA_PLATFORM_FK) references testplatform (TP_ID);
ALTER TABLE CHECKALLRTLLOG ADD CONSTRAINT CHECKALLRTLLOG_CHECKALLRTL_FK FOREIGN KEY (CAL_CHECKALLRTL_FK) REFERENCES CHECKALLRTL (CA_ID);
