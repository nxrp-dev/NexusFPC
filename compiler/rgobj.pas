...
//      Pspill_temp_list=^Tspill_temp_list;
      ...
      private
        ...
        frozen_moves,
        coalesced_moves,
        constrained_moves : TIntrusiveDeque;
        { in this region we allocate all moveins which should be disposed after register allocation finishes,
...
{$endif extdebug}
    ...
    {$endif}
      ...
      i:=move_rgn.Push(sizeof(Tmoveins));
