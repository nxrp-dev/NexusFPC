...
type
  ...
  public
    ...
    property WhiteSpace : Boolean read GetWhiteSpace;
    property HangulSyllable : Boolean read GetHangulSyllable;
    property UnifiedIdeograph : Boolean read GetUnifiedIdeograph;
    property NumericValue : Double read GetNumericValue;
  end deprecated 'Use GetCategory() etc., this is a wrapper.';
