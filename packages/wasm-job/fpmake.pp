...
{$endif ALLPACKAGES}
    P.Version:='3.3.1';
    P.OSes:=  [atari,gba,go32v2,msdos,nativent,nds,netware,netwlibc,sinclairql,human68k,symbian,watcom,wii,win32,win64,wince,freertos,wasip1,wasip1threads]+AllUnixOSes-[QNX];
